...
# Dataset
Os dados gerados para estudos com IA não são de autoria própria e usados apenas com fins educacionais. Devidos créditos ao autor o usuário Mukul Bhele link para acesso ao dataset original: https://github.com/mukul-bhele/vehicletelematics.

# Iniciativa
Projeto realizando no âmbito dos Projetos de Interesse
Nacional nas Áreas de TIC (PPI) do Ministério da Ciência, Tecnologia e Inovação (MCTI), com recursos da Lei nº 8.248, de 23 de outubro de 1991, publicado como Residência em TIC 09 (processo 01245.014045/2022-75) coordenado pela Associação para Promoção da Excelência do Software Brasileiro - Softex, através do laboratório Assert, credenciado ao Polo de Inovação do IFPB.
